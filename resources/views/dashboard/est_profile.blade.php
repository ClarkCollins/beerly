                ...
                <div class="scroll-sidebar">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav">
                            ...
                            <li> <a class="active"  href="/establishment_profile" aria-expanded="false"><i class="fa fa-building"></i>Establishment Profile</a>
            ...
            <div class="page-wrapper" style="height:1200px;">
                ...
                <div class="container-fluid">
                    ...
                    <script>
                                                swal({
                              title: "",
                              text: "You have successfully added an establishment!",
                              icon: "success"
                            });
                    </script>
                    @endif
                    ...
                    <script>
                                                swal({
                              title: "",
                              text: "You have successfully deleted your establishment!",
                              icon: "success"
                            });
                    </script>
                    @endif
                    ...
                    <script>
                                                swal({
                              title: "",
                              text: "You have successfully updated your establishment!",
                              icon: "success"
                            });
                    </script>
                    @endif
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">List of Establishments</h6>
                            ...
                            <div class="table-responsive m-t-40">
                                 <table id="myTable" class="table-bordered table-striped"cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a id="editBtn"href = '/update_establishment_view/{{ $establishment->id }}'>Edit</a>,
