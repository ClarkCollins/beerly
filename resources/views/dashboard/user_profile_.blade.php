                                                ...
                                                <div class="tab-pane" id="tab_default_3">
                                                    <div class="container"><br><br><br>
                                                        ...
                                                        <table class="table table-hover">
                                                            ...
                                                            <tbody>
                                                                @foreach ($subscription_account as $sb)

                                                                @if ($sb->creator_id == Session::get('id'))
                                                                <tr>
                                                                    <td>
                                                                        <?php
                                                                        $ref1 = substr(Auth::user()->reference, 0, 4);
                                                                        $ref2 = substr(Auth::user()->reference, 4, 4);
                                                                        $ref3 = substr(Auth::user()->reference, 8, 4);
                                                                        echo "<p style='color:green'>" . strtoupper($ref1 . "-" . $ref2 . "-" . $ref3);
                                                                        ?>
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                        echo "<p style='color:green'>" . date("d/m/Y", strtotime(date('m', strtotime('+1 month')) . '/01/' . date('Y') . ' 00:00:00'));
                                                                        ?>
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                        $date_ = date('Y-m-d');
                                                                        $s_date_ = date('Y-m-01', strtotime($date_));
                                                                        $l_date_ = date('Y-m-t', strtotime($date_));
                                                                        $l_dates_ = date('Y-m-t', strtotime($date_));
                                                                        $db_date_ = $sb->payment_date;
                                                                        $db_d = new DateTime($date_);
                                                                        $db_d2 = new DateTime($l_dates_);
                                                                        $diff = date_diff($db_d2, $db_d);
                                                                        if ($db_date_ >= $s_date_ && $db_date_ <= $l_date_) {
                                                                            echo "<p style='color:green'>" . $diff->format("%d days");
                                                                        } else {
                                                                            echo "<p style='color:green'>" . "0 days";
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                    <td>
                                                                        ...
                                                                        $l_date = date('Y-m-t', strtotime($date));
                                                                        $db_date = $sb->payment_date;
                                                                        if ($db_date >= $s_date && $db_date <= $l_date) {
                                                                            echo "<p style='color:green'>" . "Active";
                                                                        } else {
                                                                            echo "<p style='color:red'>" . "Expired";
                                                                        }
                                                                        ?>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                <div class="col-md-6 ">
                                                                    <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}" >
                                                                        <br> <label>First Name</label>
                                                                        <input id="first_name" name="first_name"  type="text" value="<?php echo ucfirst(Auth::user()->first_name); ?>" class="form-control" autofocus>
                                                                        @if ($errors->has('first_name'))
                                                                        <span class="help-block">
                                                                            <strong>{{ $errors->first('first_name') }}</strong>
                                                                        </span>
                                                                ...
                                                                <div class="col-md-6 ">
                                                                    <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }}" >
                                                                        <br> <label>Last Name</label>
                                                                        <input id="last_name" name="last_name"  type="text" value="<?php echo ucfirst(Auth::user()->last_name); ?>" class="form-control" autofocus>
                                                                        @if ($errors->has('last_name'))
                                                                        <span class="help-block">
                                                                            <strong>{{ $errors->first('last_name') }}</strong>
                                                                        </span>
