            ...
            <div class="page-wrapper" style="height:1200px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action="/add_establishment" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-body">
                                        <div class="row p-t-20">
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required  type="text" id="name" name="name" class="form-control" value="{{ old('name') }}"autofocus>
                                                    @if ($errors->has('name'))
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('contact_person') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required  type="text" id="contact_person" name="contact_person" value="{{ old('contact_person') }}" class="form-control" autofocus>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('contact_number') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required  type="text" pattern="(?=.*\d).{10,10}"title="this is a numeric field and has to be 10 characters" id="contact_number" name="contact_number" value="{{ old('contact_number') }}" class="form-control" autofocus> </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}" >
                                                    <label>Address</label>
                                                    <input required id="autocomplete" name="address"  type="text" value="{{ old('address') }}" class="form-control" autofocus>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('liqour_license') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required  type="text" name="liqour_license" id="liqour_license" value="{{ old('liqour_license') }}" class="form-control" autofocus>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('hs_license') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required  type="text" name="hs_license" id="hs_license" value="{{ old('hs_license') }}" class="form-control" autofocus>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('establishment_url') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required type="url" placeholder="e.g. http:www.google.com" pattern="https?://.+" title="Include http://" id="establishment_url" name="establishment_url" class="form-control" value="{{ old('establishment_url') }}" autofocus>
                                            ...
                                            <div class="col-md-6">
                                               <div class="form-group{{ $errors->has('last_inspection_date') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required max="<?php echo date('Y-m-d') ?>" type="date" id="last_inspection_date" name="last_inspection_date" value="{{ old('last_inspection_date') }}" class="form-control" autofocus placeholder="dd/mm/yyyy">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('latitude') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required id="latitude" name="latitude" type="text" value="{{ old('latitude') }}" class="form-control" autofocus>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group{{ $errors->has('longitude') ? ' has-error' : '' }}" >
                                                    ...
                                                    <input required id="longitude" name="longitude" type="text" value="{{ old('longitude') }}" class="form-control" autofocus>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group{{ $errors->has('main_picture_url') ? ' has-error' : '' }}" >
                                                    <label>Photos</label>
                                                    <input accept=".jpeg, .jpg, .jpe, .jfif, .jif,.png,image/*" multiple="true" id="main_picture_url" name="main_picture_url[]" type="file" value="user.jpeg" class="form-control" autofocus>
