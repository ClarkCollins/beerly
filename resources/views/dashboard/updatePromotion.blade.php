            ...
            <div class="page-wrapper" style="height:1200px;">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <form action="/update_promo/<?php echo $promotions[0]->id; ?>" enctype="multipart/form-data"  method="post">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <a type="button" class="btn btn-inverse" href="/establishment_promo"> Cancel </a><br><br><br>
                                    </div>
                                </div>
                            </form>
